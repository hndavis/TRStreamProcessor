...
namespace WCFBroadCastClient.BroadcastorService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="BroadcastorService.IBroadcastorService", CallbackContract=typeof(WCFBroadCastClient.BroadcastorService.IBroadcastorServiceCallback))]
    public interface IBroadcastorService {
        ...
        void NotifyServer(WCFBroadCastClient.BroadcastorService.EventDataType eventData);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IBroadcastorService/NotifyServer")]
        System.Threading.Tasks.Task NotifyServerAsync(WCFBroadCastClient.BroadcastorService.EventDataType eventData);
    }
    ...
    public interface IBroadcastorServiceCallback {
        ...
        void BroadcastToClient(WCFBroadCastClient.BroadcastorService.EventDataType eventData);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBroadcastorServiceChannel : WCFBroadCastClient.BroadcastorService.IBroadcastorService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BroadcastorServiceClient : System.ServiceModel.DuplexClientBase<WCFBroadCastClient.BroadcastorService.IBroadcastorService>, WCFBroadCastClient.BroadcastorService.IBroadcastorService {
        ...
        public void NotifyServer(WCFBroadCastClient.BroadcastorService.EventDataType eventData) {
            base.Channel.NotifyServer(eventData);
        }
        
        public System.Threading.Tasks.Task NotifyServerAsync(WCFBroadCastClient.BroadcastorService.EventDataType eventData) {
